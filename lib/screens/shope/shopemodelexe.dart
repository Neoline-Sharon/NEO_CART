...
Shopemodelexe shopemodelexeFromJson(String str) => Shopemodelexe.fromJson(json.decode(str));
String shopemodelexeToJson(Shopemodelexe data) => json.encode(data.toJson());
class Shopemodelexe {
  Shopemodelexe({
  ...
  Shopemodelexe.fromJson(dynamic json) {
  ...
  dynamic _gender;
  String? _productType;
Shopemodelexe copyWith({  String? cartDetailsId,
  String? cartId,
  String? stockId,
  String? quantity,
  String? productName,
  ...
  dynamic gender,
  String? productType,
}) => Shopemodelexe(  cartDetailsId: cartDetailsId ?? _cartDetailsId,
