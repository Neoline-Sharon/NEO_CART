...
class catogoryproductpage extends StatefulWidget {
  final int? num;
  const catogoryproductpage({super.key, required this.num});

  @override
  State<catogoryproductpage> createState() => _catogoryproductpageState();
}

class _catogoryproductpageState extends State<catogoryproductpage> {
  @override
          ...
          child: Row(
            ...
            children: [
              ...
              MaterialButton(
                ...
                // onPressed: (){
                //   // buynow(customerid,catagrorypagelist[num!].stockId.toString(),catagrorypagelist[num!].mrpp.toString(),catagrorypagelist[num!].sellingPrice.toString(),context);
                // }
                child: Row(
                children: [
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        child: Container(
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  image: NetworkImage(catagrorypagelist[widget.num!].productImage.toString()))),
                          height: 227,
                          width: 328,
                        ),
                      ),
                      hi,
                      Text(catagrorypagelist[widget.num!].productName.toString(),
                        style: TextStyle(fontSize: 20, color: Color(0xff555454)),
                      ),
                      hi,
                      Text(
                        catagrorypagelist[widget.num!].urlName.toString(),
                      ...
                      Row(
                        children: [
                          Text(
                            catagrorypagelist[widget.num!].sellingPrice.toString(),
                          ...
                          Text(
                            catagrorypagelist[widget.num!].mrpp.toString(),
                            style: TextStyle(
                                fontSize: 14,
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      hi,
                      Text(catagrorypagelist[widget.num!].productName.toString(),style: TextStyle12,),
                    ],
                  ),
                ),
                hi,
