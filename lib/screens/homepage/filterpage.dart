...
class filtterpage extends StatelessWidget {
  final int? num;
  const filtterpage({super.key, required this.num});
          ...
          child: Row(
            ...
            children: [
              ...
              MaterialButton(
                ...
                color: Colors.black,
                onPressed: (){
                  buynow(customerid,Allproducteslistfitter[num!].stockId.toString(),Allproducteslist[num!].mrpp.toString(),Allproducteslist[num!].sellingPrice.toString(),0,context);
                },child: Row(
                children: [
                    ...
                    child: Column(
                      ...
                      children: [
                          ...
                          child: Container(
                            decoration: BoxDecoration(
                                ...
                                image: DecorationImage(
                                    image: NetworkImage(Allproducteslistfitter[num!].productImage.toString()))),
                            height: 227,
                            width: 328,
                          ),
                        ),
                        hi,
                        Text(Allproducteslistfitter[num!].productName.toString(),
                          style: TextStyle(fontSize: 20, color: Color(0xff555454)),
                        ),
                        hi,
                        Text(
                          Allproducteslistfitter[num!].urlName.toString(),
                        ...
                        Row(
                          children: [
                            Text(
                              Allproducteslistfitter[num!].sellingPrice.toString(),
                            ...
                            Text(
                              Allproducteslistfitter[num!].mrpp.toString(),
                              style: TextStyle(
                                  fontSize: 14,
